...
function setIgFollowerData() {
  ...
  var startRow = 2;
  var range = igFollowerSheet.getRange(startRow, 1, igFollowerSheet.getLastRow(), 1);
  ...
  igFollowerSheet.getRange(startRow, dateColumn.getColumn(), igFollowerSheet, 1).setValues(data);
}
